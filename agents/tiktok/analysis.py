...
async def clean_raw_data(user_request: str, tiktok_data: List[Dict], next_step: str = None ) -> List[Any]:
    """
    ...
    Args:
        ...
        tiktok_data: Raw data from TikTok.
    ...
    try:
        df = pd.json_normalize(tiktok_data)
